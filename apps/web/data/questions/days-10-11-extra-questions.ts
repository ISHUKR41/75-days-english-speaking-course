...
export const DAY_10_EXTRA_QUESTIONS: PracticeQ[] = [
  ...
  q("d10-ex-q075","d10-t2-s2","'Meri sister ek doctor hai aur woh AIIMS mein kaam karti hai.' ko English mein translate karo.","translation","My sister is a doctor and she works at AIIMS.","My sister is (Be Verb) + she works (Present Simple). Third person.","My sister = meri sister; she works at AIIMS = woh AIIMS mein kaam karti hai.",5,undefined,[{word:"my sister is a doctor",meaning:"meri sister doctor hai"},{word:"she works at",meaning:"woh kaam karti hai"}]),
  ...
  q("d10-ex-q081","d10-t1-s1","'It ___ raining outside.' (present) — fill in.","fill_blank","is","It = singular. Is + V-ing = Present Continuous. It is raining.","It is raining = bahar baarish ho rahi hai.",5,undefined,[{word:"it is raining",meaning:"baarish ho rahi hai"}]),
